...
import { getArticles } from './blog-store.js';
...
export const KB_CATALOG = {
  m365: {
    ...
    files: [
      ...
      'm365-feature-availability-official.md',
      'copilot-studio-licensing.md',
      'microsoft-365-collaboration.md',
      'microsoft-licensing-contracts-guide.md',
      'csp-vs-mca-decision-guide.md',
      'm365-licensing-faq.md',
      'm365-recent-updates.md',
    ],
  },
  azure: {
    ...
    emoji: '☁️',
    color: 'sky',
    files: ['azure-recent-updates.md', 'azure-pricing-2025.md', 'azure-migration.md'],
  },
  dynamics: {
    label: 'Dynamics 365',
    emoji: '🎯',
    color: 'orange',
    files: ['dynamics-recent-updates.md', 'dynamics-365-fo-modules-architecture.md', 'dynamics-365-ai-agents-complete.md', 'dynamics-365-licensing-implementation-guide.md', 'dynamics-365-modules-overview.md', 'dynamics-365-pricing-2025.md'],
  },
  power: {
    label: 'Power Platform',
    emoji: '⚡',
    color: 'yellow',
    files: ['power-platform-digital.md', 'copilot-studio-licensing.md'],
  },
  devtools: {
    label: 'Developer Tools',
    emoji: '💻',
    color: 'violet',
    files: ['github-copilot-plans.md'],
  },
  security: {
    label: 'Security & Compliance',
    emoji: '🛡️',
    color: 'red',
    files: ['security-compliance.md', 'modern-workplace-security-framework.md', 'microsoft-intune-licensing.md'],
  },
  bundles: {
...
function getBlogContent(topics = []) {
  ...
  const matched = getArticles().filter(article => {
...
export function getKbMeta() {
  ...
  return {
    ...
    blogArticles: getArticles().length,
...
export function detectTopics(text) {
  ...
  const signals = {
    m365:     ['m365', 'microsoft 365', 'teams', 'sharepoint', 'exchange', 'outlook', 'office', 'onedrive', 'e3', 'e5', 'e7', 'copilot', 'frontier', 'viva', 'frontline', 'f1', 'f3', 'apps enterprise', 'licensing', 'scim', 'modern work', 'feature availability', 'disponibilité', 'plan m365', 'licence', 'plan microsoft'],
    ...
    power:    ['power bi', 'power apps', 'power automate', 'power platform', 'low-code', 'no-code', 'copilot studio', 'power virtual agents', 'chatbot', 'agent ia', 'bot'],
    security: ['security', 'defender', 'sentinel', 'compliance', 'rgpd', 'gdpr', 'zero trust', 'mfa', 'identité', 'nis2', 'purview', 'entra', 'modern workplace', 'conditional access', 'sécurité', 'accès conditionnel', 'intune', 'mdm', 'mam', 'endpoint', 'privilege management', 'epm'],
    bundles:  ['bundle', 'pack', 'promotion', 'remise', 'roi', 'tco', 'prix', 'tarif'],
    devtools: ['github copilot', 'github', 'dev', 'développeur', 'developer', 'code completion', 'vs code', 'visual studio', 'jetbrains', 'copilot enterprise', 'copilot business'],
  };
