...
export const KB_CATALOG = {
  ...
  security: {
    ...
    emoji: '🛡️',
    color: 'red',
    files: ['security-compliance.md', 'modern-workplace-security-framework.md'],
  },
  bundles: {
...
export function detectTopics(text) {
  ...
  const signals = {
    ...
    security: ['security', 'defender', 'sentinel', 'compliance', 'rgpd', 'gdpr', 'zero trust', 'mfa', 'identité', 'nis2', 'purview', 'entra', 'modern workplace', 'conditional access', 'sécurité', 'accès conditionnel'],
