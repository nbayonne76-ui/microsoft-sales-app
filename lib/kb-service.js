...
export const KB_CATALOG = {
  ...
  dynamics: {
    ...
    emoji: '🎯',
    color: 'orange',
    files: ['dynamics-recent-updates.md', 'dynamics-365-ai-agents-complete.md', 'dynamics-365-licensing-implementation-guide.md', 'dynamics-365-modules-overview.md', 'dynamics-365-pricing-2025.md'],
  },
  power: {
